...
var hastagSearch = { q: '#Linux', count: 10, result_type: 'recent' }
...
function followed (event) {
  ...
  var response = 'Thanks for the follow! '+ name + ' @' + screenName + ' #InstallGentoo #NodeJS' // Post that tweet! 
...
function tweetEvent (tweet) {
  ...
  if (reply_to === 'selftwitterhandle') {
    ...
    var reply = 'Hi @' + name + ' ' + ', Thanks for the mention #InstallGentoo #NodeJS'
